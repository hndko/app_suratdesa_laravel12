...
<div class="d-flex align-items-center mb-3">
    <div>
        ...
        <h1 class="page-header mb-0">Edit Jenis Surat</h1>
    </div>
</div>

<div class="card">
    <div class="card-body">
        <form action="{{ route('jenis-surat.update', $jenis_surat->id) }}" method="POST">
            @csrf
            @method('PUT')
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('kode_surat') is-invalid @enderror" name="kode_surat"
                        value="{{ old('kode_surat', $jenis_surat->kode_surat) }}" placeholder="Contoh: 470">
                    @error('kode_surat')
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control @error('nama_surat') is-invalid @enderror" name="nama_surat"
                        value="{{ old('nama_surat', $jenis_surat->nama_surat) }}"
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('kop_judul') is-invalid @enderror" name="kop_judul"
                    value="{{ old('kop_judul', $jenis_surat->kop_judul) }}" placeholder="SURAT KETERANGAN USAHA">
                @error('kop_judul')
                <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control @error('template_isi') is-invalid @enderror" name="template_isi" rows="10"
                    placeholder="Tulis template surat disini...">{{ old('template_isi', $jenis_surat->template_isi) }}</textarea>
