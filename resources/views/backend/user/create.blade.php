...
<div class="user-form-page">
    <div class="user-form-hero">
        <div>
            ...
            <h1>{{ $title }}</h1>
            <p>Buat akun staff desa, pilih role akses, dan isi nomor WhatsApp bila akun perlu menerima notifikasi otomatis.</p>
        </div>
                ...
                <div class="user-form-panel">
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" value="{{ old('name') }}" placeholder="Contoh: Operator Desa" required>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" id="email" name="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email') }}" placeholder="nama@simades.local" required>
                    ...
                    <div class="form-group mb-0">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" id="phone" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone') }}" placeholder="Contoh: 6281234567890">
                            @error('phone')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <small class="form-text text-muted">Nomor ini dipakai untuk notifikasi akun baru dan integrasi WhatsApp bila aktif.</small>
                    </div>
                </div>
            </div>
