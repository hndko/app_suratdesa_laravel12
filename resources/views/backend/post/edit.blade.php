...
<div class="post-form-page">
    <div class="post-form-hero">
        <div>
            ...
            <h1>{{ $title }}</h1>
            <p>Perbarui pengumuman desa, ganti gambar unggulan, atau ubah status publikasi tanpa menghapus riwayat konten.</p>
        </div>
    ...
    <form action="{{ route('post.update', $post->id) }}" method="POST" enctype="multipart/form-data" class="post-form-grid">
        @csrf
        @method('PUT')
        <div class="post-form-panel">
            ...
            <div class="form-group">
                ...
                <div class="input-group">
                    ...
                    <input type="text" id="title" name="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $post->title) }}" placeholder="Contoh: Jadwal Pelayanan Desa Minggu Ini" required>
            ...
            <div class="form-group">
                ...
                <textarea name="content" id="summernote" class="form-control @error('content') is-invalid @enderror" rows="10" placeholder="Tulis konten pengumuman di sini..." required>{{ old('content', $post->content) }}</textarea>
        ...
        <div class="post-side-panel">
            ...
            <div class="form-group">
                ...
                <label class="upload-preview" for="image">
                    ...
                    <img id="imagePreview" src="{{ $post->image ? asset('storage/' . $post->image) : asset('assets/dist/img/avatar5.png') }}" alt="Preview gambar" loading="lazy">
                    <span><i class="fas fa-camera mr-1"></i> Pilih gambar</span>
                    <small id="imageMeta">{{ $post->image ? 'Gambar saat ini. Pilih file baru untuk mengganti.' : 'JPG, PNG, atau WEBP. Maksimal 2 MB.' }}</small>
                </label>
            ...
            <div class="guide-box">
                ...
                <span>Gambar lama otomatis diganti hanya jika Anda memilih file baru.</span>
            </div>
        </div>
    </form>
</div>
