    ...
    <div class="card-body">
        <form action="{{ route('penduduk.update', $penduduk->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="phone" class="form-control" placeholder="Contoh: 0812..."
                            value="{{ old('phone', $penduduk->phone) }}" required>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="tgl_lahir" class="form-control"
                            value="{{ old('tgl_lahir', $penduduk->tgl_lahir) }}" required>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <select name="status_perkawinan" class="form-select" required>
                            ...
                            <option value="Kawin" {{ old('status_perkawinan', $penduduk->status_perkawinan) == 'Kawin' ?
                                'selected' : '' }}>Kawin</option>
                            <option value="Cerai Hidup" {{ old('status_perkawinan', $penduduk->status_perkawinan) ==
                                'Cerai Hidup' ? 'selected' : '' }}>Cerai Hidup</option>
                            <option value="Cerai Mati" {{ old('status_perkawinan', $penduduk->status_perkawinan) ==
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="rt" class="form-control" placeholder="001"
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="number" name="rw" class="form-control" placeholder="001"
            ...
            <div class="d-flex justify-content-end">
                ...
                <button type="submit" class="btn btn-primary"><i class="fa fa-save me-1"></i> Update Data</button>
            </div>
        </form>
    </div>
</div>
