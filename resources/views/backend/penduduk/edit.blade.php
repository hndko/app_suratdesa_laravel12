...
<div class="resident-form-page">
    <div class="resident-form-hero">
        <div>
            ...
            <h1>{{ $title }}</h1>
            <p>Perbarui data {{ $penduduk->nama }} agar informasi kependudukan tetap akurat untuk layanan administrasi desa.</p>
        </div>
    ...
    <form action="{{ route('penduduk.update', $penduduk->id) }}" method="POST" enctype="multipart/form-data" class="resident-form-card">
        @csrf
        @method('PUT')
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="nik" class="form-control @error('nik') is-invalid @enderror" value="{{ old('nik', $penduduk->nik) }}" maxlength="16" inputmode="numeric" placeholder="16 digit NIK" required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <select name="kartu_keluarga_id" class="form-control">
                            ...
                            <option value="{{ $kk->id }}" {{ old('kartu_keluarga_id', $penduduk->kartu_keluarga_id) == $kk->id ? 'selected' : '' }}>{{ $kk->no_kk }} - {{ $kk->kepala_keluarga }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $penduduk->nama) }}" placeholder="Nama sesuai KTP" required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="phone" class="form-control @error('phone') is-invalid @enderror" value="{{ old('phone', $penduduk->phone) }}" placeholder="Contoh: 081234567890" required>
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="tempat_lahir" class="form-control @error('tempat_lahir') is-invalid @enderror" value="{{ old('tempat_lahir', $penduduk->tempat_lahir) }}" placeholder="Kota kelahiran" required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="date" name="tgl_lahir" class="form-control @error('tgl_lahir') is-invalid @enderror" value="{{ old('tgl_lahir', $penduduk->tgl_lahir) }}" required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="pekerjaan" class="form-control @error('pekerjaan') is-invalid @enderror" value="{{ old('pekerjaan', $penduduk->pekerjaan) }}" placeholder="Pekerjaan saat ini" required>
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="pendidikan" class="form-control @error('pendidikan') is-invalid @enderror" value="{{ old('pendidikan', $penduduk->pendidikan) }}" placeholder="Pendidikan terakhir" required>
        ...
        <div class="form-section">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3" placeholder="Alamat jalan/dusun lengkap" required>{{ old('alamat', $penduduk->alamat) }}</textarea>
            ...
            <div class="row">
                <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="rt" class="form-control @error('rt') is-invalid @enderror" value="{{ old('rt', $penduduk->rt) }}" inputmode="numeric" placeholder="001" required>
                ...
                <div class="col-md-3 mb-3">
                    ...
                    <div class="input-group">
                        <div class="input-group-prepend"><span class="input-group-text"><i class="fas fa-map-pin"></i></span></div>
                        <input type="text" name="rw" class="form-control @error('rw') is-invalid @enderror" value="{{ old('rw', $penduduk->rw) }}" inputmode="numeric" placeholder="002" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="upload-preview">
                        ...
                        <img id="fotoKtpPreview" src="{{ Storage::url($penduduk->foto_ktp) }}" alt="Preview KTP" loading="lazy">
                        @else
                        ...
                        <div class="upload-content">
                            ...
                            <small>Biarkan kosong jika tidak ingin mengganti foto. Maksimal 2 MB.</small>
                        </div>
                    </div>
                </div>
            </div>
