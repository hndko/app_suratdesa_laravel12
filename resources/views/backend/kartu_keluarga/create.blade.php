...
<div class="kk-form-page">
    <div class="kk-form-hero">
        <div>
            ...
            <h1>{{ $title }}</h1>
            <p>Masukkan data dasar keluarga agar penduduk dapat dikelompokkan dan layanan surat lebih mudah diproses.</p>
        </div>
    ...
    <form action="{{ route('kartu-keluarga.store') }}" method="POST" class="kk-form-card">
        @csrf
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="no_kk" class="form-control @error('no_kk') is-invalid @enderror" value="{{ old('no_kk') }}" maxlength="16" inputmode="numeric" placeholder="Contoh: 3201010101010001" required>
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="kepala_keluarga" class="form-control @error('kepala_keluarga') is-invalid @enderror" value="{{ old('kepala_keluarga') }}" placeholder="Nama kepala keluarga" required>
        ...
        <div class="form-section">
            ...
            <div class="mb-3">
                ...
                <div class="input-group">
                    ...
                    <textarea name="alamat" class="form-control @error('alamat') is-invalid @enderror" rows="3" placeholder="Contoh: Dusun Mawar, Jalan Melati No. 10" required>{{ old('alamat') }}</textarea>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="kecamatan" class="form-control @error('kecamatan') is-invalid @enderror" value="{{ old('kecamatan') }}" placeholder="Nama kecamatan">
            ...
            <div class="row">
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="kabupaten" class="form-control @error('kabupaten') is-invalid @enderror" value="{{ old('kabupaten') }}" placeholder="Nama kabupaten">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="provinsi" class="form-control @error('provinsi') is-invalid @enderror" value="{{ old('provinsi') }}" placeholder="Nama provinsi">
                ...
                <div class="col-md-4 mb-3">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="kode_pos" class="form-control @error('kode_pos') is-invalid @enderror" value="{{ old('kode_pos') }}" inputmode="numeric" placeholder="Kode pos">
